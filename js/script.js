...
//  (function() {
	...
	// 해외교회 정보
	const MAPSOPT1 = [
		{name: '중국', left: 41, top:41, since:'1917', site:'http://www.tjc.org.cn', desc: '중국교회 소개'},
	...
	// 국내교회 정보
	const MAPSOPT2 = [
		{name: '김천교회', left: 50, top:50, since:'1948', site:'경상북도 김천시 평화중앙3길 30', tel: '054-434-2071', image:"./images/church/gimcheon.jpg"},
		{name: '삼계교회', left: 36.7, top:62.9, since:'1948', site:'전라북도 임실군 삼계면 삼계리 충효로 1315-3', tel: '063-642-7619', image:"./images/church/samgye.jpg"},
		{name: '서도교회', left: 37.7, top:64.7, since:'1949', site:'전라북도 남원시 사매면 노봉길 9', desc: '063-634-8430', image:"./images/church/seodo.jpg"},
		{name: '전주교회', left: 35.3, top:57.5, since:'1952', site:'전라북도 전주시 완산구 백제대로 20-37(평화동1가)', tel: '063-223-6451', image:"./images/church/jeonju.jpg"},
		{name: '동부교회', left: 34, top:23, since:'1954', site:'서울특별시 동대문구 회기로 23가길 12(회기동)', tel: '02-966-4294', image:"./images/church/dongbu.jpg"},
		...
		{name: '부산교회', left: 65.8, top:70.5, since:'1958', site:'부산광역시 금정구 서금로 37-10, (서동)', tel: '070-7374-0278', image:"./images/church/busan.jpg"},
		{name: '남원교회', left: 39.1, top:66, since:'1958', site:'전라북도 남원시 노송로 1261 (노암동)', tel: '063-625-6219', image:"./images/church/namwon.jpg"},
		{name: '대전교회', left: 40, top:47.5, since:'1959', site:'대전시 동구 천동 72-1', tel: '042-283-3865', image:"./images/church/daejeon.jpg"},
		{name: '수문교회', left: 33.2, top:77.9, since:'1964', site:'전라남도 장흥군 안양면 수문4길 6', tel: '061-862-1092', image:"./images/church/sumun.jpg"},
		{name: '안동교회', left: 60.8, top:40.7, since:'1965', site:'경상북도 안동시 득심골길 32-8 (상아동)', tel: '054-852-3207', image:"./images/church/andong.jpg"},
		{name: '서부교회', left: 31, top:23, since:'1965', site:'서울특별시 은평구 통일로50길 2-2 (녹번동)', tel: '02-355-8851', image:"./images/church/seobu.jpg"},
		...
		{name: '목포교회', left: 22.3, top:78.1, since:'1979', site:'전라남도 목포시 복산길6번길 34 (옥암동)', tel: '061-238-5732', image:"./images/church/mokpo.jpg"},
		{name: '광주교회', left: 30.1, top:67.7, since:'1985', site:'광주광역시 광산구 목련로394번길 10-12 (신가동)', tel: '062-951-2334', image:"./images/church/gwangju.jpg"},
		{name: '인천교회', left: 28, top:24.7, since:'1986', site:'인천광역시 남동구 백범로73번길 15 (만수동)', tel: '032-473-1009', image:"./images/church/incheon.jpg"},
		{name: '거제교회', left: 60.3, top:75.4, since:'1987', site:'경상남도 거제시 연초면 다공2길 27', tel: '070-4143-7834', image:"./images/church/geoje.jpg"},
		{name: '평택교회', left: 32.9, top:33.9, since:'1987', site:'경기도 오산시 은여울로7번길 13-3 (궐동)', tel: '373-2641', image:"./images/church/pyeongtaek.jpg"},
		{name: '안산교회', left: 30.8, top:28.3, since:'1988', site:'경기 안산시 상록구 사동 1528-15번지, 2층', tel: '031-408-2301', image:"./images/church/ansan.jpg"},
		{name: '강남교회', left: 34, top:26, since:'1989', site:'서울특별시 강남구 일원로3길 30 (일원동)', tel: '02-459-8557', image:"./images/church/gangnam.jpg"},
		{name: '수원교회', left: 34, top:32.7, since:'1990', site:'경기도 수원시 권선구 매송고색로533번길 7(오목천동,태산아파트)상가3동 301-304호', tel: '031-293-3504', image:"./images/church/suwon.jpg"},
		{name: '광양교회', left: 41.8, top:74.1, since:'1996', site:'전남 광양시 광양읍 덕례리 1673-2', tel: '061-762-0513', image:"./images/church/gwangyang.jpg"},
		{name: '장항서부교회', left: 30.1, top:53.6, since:'1996', site:'충청남도 서천군 장항읍 장항로 91번길 17', tel: '041-956-5746', image:"./images/church/janghang-seobu.jpg"},
		{name: '분당교회', left: 37.5, top:23.3, since:'2000', site:'경기도 성남시 분당구 벌말로 41 (야탑동) 성원프라자 5층 503호', tel: '031-709-0191', image:"./images/church/bundang.jpg"},
		{name: '원주교회', left: 47.8, top:27.6, since:'2002', site:'강원도 원주시 행가리1길 67 (무실동) ', tel: '033-766-1348', image:"./images/church/wonju.jpg"},
		{name: '천안교회', left: 36.3, top:34.8, since:'2002', site:'충청남도 천안시 서북구 쌍용대로 43 (쌍용동)(유웅선 내과 4층)', tel: '041-568-0568', image:"./images/church/cheonan.jpg"},
		{name: '보령교회', left: 26.9, top:47.6, since:'2006', site:'충청남도 보령시 명천중앙길 20(명천동) 정은스카이빌 103동1003호', tel: '935-6254', image:""},
		{name: '안양교회', left: 33.8, top:23.6, since:'2008', site:'경기도 안양시 만안구 석천로211번길 82 (석수동) 삼우BD 3층', tel: '031-473-0291', image:"./images/church/anyang.jpg"},
		...
		{name: '제주선교센터', left: 17, top:93.2, since:'2020', site:'제주도 제주시 애월읍 고성서3길 22', tal: '', image:"./images/church/jeju.jpg"},
	...
	"06":
		...
		{ 
			...
			[
				{
					title: "참예수교회 기본신앙 9항 구원론 1부 구원은 하나님의 은혜로 주시는 것입니다.",
	...
	const faq_data = {
		...
		{ 
			...
			[
				...
				},
				{
					...
					description: "참예수교회는 성경의 예언대로 예수 그리스도께서 늦은비 성령으로 세우신 교회로서 특별한 인물이 창시자나 교주로 추앙되지 않습니다."
				},
				{
					title : "참예수교회는 타교단과 어떤 차이점이 있습니까?", 
					description: "참예수교회는 예수 그리스도께서 늦은비 성령으로 세우신 사도교회의 신앙을 추구하여 사도시대와 같은 약속의 성령, 사도시대와 같은 성례(세례, 성찬례, 세족례), 사도시대와 같은 안식일 준수를 표방하는 기독교 정통 신앙의 교단입니다."
				},
				{
					title : "참예수교회는 타 기독교단의 신앙에 대해 어떤 생각을 가지고 있습니까?", 
					description: "본회는 우상숭배와 이교 문화로 변질된 천주교를 기독교에 속하지 않은 교단으로 간주하며 개신교는 예수 그리스도에 대한 탄생, 죽음, 부활, 승천, 그리고 재림에 대한 믿음의 내용이 본회의 신앙과 공통적이지만 구원론과 관련된 중요한 교리가 변질, 변경되었으므로 성경의 진리를 깨닫고 사도교회와 같은 본래의 신앙으로 개혁되어야 한다고 봅니다."
				}
			]
		},
		"02":
			...
			[
				{
					...
					description : "참예수교회는 구약 39권 신약 27권의 기독교 정경을 인정하며 한국총회에서는 개역한글판 역본을 공식 예배 성경으로, 개역개정판을 참고용으로 사용하고 있습니다. 일반 개신교에서 외경으로 분류하는 경권이 포함된 천주교에서 사용하는 경전은 인정하지 않습니다. 본회의 영어권에서는 뉴킹제임스 역본을 공식 지정 성경으로, 중국어권에서는 화합역본을 공식 지정 성경으로 사용하고 있습니다."
				},
				{
			...
			[
				{
					...
					description : "참예수교회는 기본신앙 1항에서 표명하듯이 예수 그리스도를 육신으로 오신 창조주 하나님이시며 인류를 구원하실 유일하신 참 하나님으로 믿습니다."
				},
				{
			...
			[
				{
					...
					description : "성령을 받을 때 나타나는 현상에 대한 서술은 복음서나 서신서에서는 발견 할 수 없고 오직 사도행전에서만 발견 할 수 있습니다. 사도행전 2장 44절, 33절, 10장 44-48절, 19장 5-6절에는 성령이 임하실때 직접적으로 '방언'을 말했다고 기록하고 있으며 8장에는 '방언'을 말했을 것으로 추정되는 정황이 기록되어 있습니다. 이에 대한 자세한 설명은 본회 기본신앙 5항 교육 영상을 참고하시기 바랍니다."
				},
				{
		...
		"05":
		{
			...
			[
				...
				{
					title : "참예수교회는 가정에 대해 어떤 윤리관을 가지고 있습니까?",
				...
				{
					title : "참예수교회는 남자 신도의 병역 의무에 대해 어떤 견해를 가지고 있습니까?",
					description : "참예수교회는 성도가 국민의 한 사람으로서의 의무를 다할 것을 교훈하며 병역의 의무를 거부하도록 가르치지 않습니다."
				},
			]
		},
		"06":
		{
			...
			[
				...
				},
				{
					...
					description : "성부 성자 성령으로 세례를 베풀라는 명령은 마태복음 28:19에 기록하고 있으나 이는 사도행전에서 '예수' 이름으로 세례를 주는 사실과 상반됩니다. 일반 개신교에서 아버지, 아들, 성령의 이름 곧'예수'라는 이름으로 세례를 주라는 뜻이었으나 그 뜻을 곡해했습니다. 이에 대한 자세한 설명은 기본신앙 4항의 교육 영상을 참고하시기 바랍니다."
				},
				{
		...
		"07":
		{
			...
			[
				...
				},
				{
					...
					description : "출애굽 이후 안식일을 지키고 있는 유대인들은 현재까지 동일한 날, 토요일을 안식일로 지킵니다. 또 요일의 형성 과정에 대한 각종 역사 자료를 찾아보면 자연스럽게 이해할 수 있습니다. 이에 대한 자세한 설명은 기본신앙 6항의 교육 영상을 참고하시기 바랍니다."
				},
				{
					title : "참예수교회에서 안식일을 성일로 준수하는 것은 안식교단의 것과 어떻게 다릅니까?",
					description : "안식교단은 안식일을 '구원의 표'로써 생명과 같이 여깁니다. 그래서 과도하게 '율법적 안식일 준수'의 모습으로 나타납니다. 그러나 본회에서는 '사람이 안식일을 위하여 있는 것이 아니라 안식일이 사람을 위하여 있는 것'이라는 주님의 안식일 준수 대전제의 가르침을 기초로 '은혜 아래의 안식일 준수'를 추구합니다."
				},
			]
		},
		"08":
			...
			[
				{
					...
					description : "본회는 교회의 소유권이 목회자나 장로 개인에게 귀속된 개교회 제도로 운용되는 것이 아니라 교회의 재산과 인사권이 중앙 조직에서 통제되는 총회중심제도로 운용되고 있습니다. 따라서 교회의 재산은 총회에 등록되어 있으며 목회자는 일정 기간이 지나면 임지를 교체하고 순환됩니다. 이런 제도를 소유하고 있으므로 교회의 사유화를 통해 발생하는 성직자의 대형 재정 비리, 윤리적 타락의 상황이 조장 되지 않습니다."
				},
				{
		...
		"09":
		{
			...
			[
				{
					title : "참예수교회는 그리스도의 재림에 대해서 어떤 견해를 가지고 있습니까?",
					description : "사도행전 1장에 승천 기사를 기록하고 있듯이 예수 그리스도께서 구름 가운데로 승천하신 것처럼 구름 가운데서 재림하실 것으로 믿고 있습니다. 어떤 신흥종교에서 지도자인 인물이 이미 재림한 예수라던가 죽은 인물이 재림한 예수라는 주장은 전혀 받아들이지 않습니다."
				},
				{
					title : "참예수교회는 시한부 종말론에 대해서 어떤 견해를 가지고 있습니까?",
					description : "본회는 일반 개신교에서 그렇듯이 그리스도의 재림하실 미래가 있다는 것에 대해서는 믿으나 여느 신흥 종교에서처럼 특정한 날짜에 재림하신다는 시한부 종말론은 거부합니다. 그날이 임박하면 말일이 가까왔다는 여러 가지 징조는 나타나겠으나 마태복음 24:36절에서 명시하는 바와 같이 정확한 그 날과 그 시는 아무도 모르고 오로지 하늘의 하나님만이 알고 계신다고 믿고 있습니다."
				},
			]
		}
	}
		...
		switch (currentScene) {
            ...
            case 2:		// 교회 분포 
				...
				if(currentSlide == 0) {	// 세계지도
					objs.start_year.innerText = '1917'
					...
					objs.start_year.innerText = '1948'
	...
	******************************/
	...
	function setChurchPopup(i){
		...
		if(mapSpot[i].image != null)
			pop.querySelector('.church-pic img').src = mapSpot[i].image;
